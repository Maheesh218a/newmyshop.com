...
if(empty($fname)){
    ...
    if($n > 0){
        ...
        Database::iud("INSERT INTO `users` (`fname`,`lname`,`email`,`password`,`mobile`,`joined_date`,`verfication_code`,`status`,`gender_id`) VALUES ('".$fname."','".$lname."','".$email."','".$password."','".$mobile."','".$date."','','1','".$gender."')");
