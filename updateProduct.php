...
?>
        ...
        <head>
            ...
            <title>Update Product | iMobile Shop</title>
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                    ...
                                                    $category_rs = Database::search("SELECT * FROM `catergory` WHERE `cat_id`='" . $product["cat_id"] . "'");
                                                ...
                                                <div class="row">
                                                    ...
                                                    ?>
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" id="r" name="c" disabled />
                                                                <label class="form-check-label fw-bold" for="r">Re-Condition</label>
                                                            </div>
                                                        </div>
                                                    <?php
                                                    ...
                                                    <?php
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" id="r" name="c" checked disabled />
                                                                <label class="form-check-label fw-bold" for="r">Re-Condition</label>
                                                            </div>
                                                        </div>
                                                    <?php
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <textarea cols="30" rows="15" class="form-control" style="background-color: blanchedalmond;" id="d"><?php echo $product["description"]; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label fw-bold" style="font-size: 20px; color:azure;">Add Product Images</label>
                                            </div>
                                    ...
                                    <div class="offset-lg-4 col-12 col-lg-4 d-grid mt-3 mb-3">
                                        <button class="btn btn-light" onclick="updateProduct();">Update Product</button>
                                    </div>
