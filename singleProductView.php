...
if (isset($_GET["id"])) {
    ...
    product.cat_id,product.model_has_brand_id,product.color_clr_id,product.status_id,
    ...
    $color_rs = Database::search("SELECT * FROM `product` INNER JOIN `color` ON product.color_clr_id=color.clr_id WHERE product.id = '".$pid."'");
    $color_data = $color_rs->fetch_assoc();

    $brand_rs = Database::search("SELECT * FROM `brand` INNER JOIN `model_has_brand` ON brand.brand_id=model_has_brand.brand_brand_id 
                                    INNER JOIN `product` ON model_has_brand.brand_brand_id=product.model_has_brand_id WHERE product.id = '".$pid."'");
    $brand_data = $brand_rs->fetch_assoc();

    $model_rs = Database::search("SELECT * FROM `model` INNER JOIN `model_has_brand` ON model.model_id=model_has_brand.model_model_id 
                                    INNER JOIN `product` ON model_has_brand.model_model_id=product.model_has_brand_id WHERE product.id = '".$pid."'");
...
?>
        ...
        <head>
            ...
            <title><?php echo $product_data["title"]; ?> | iMobile Shop</title>
        ...
        <body class="singleBody">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 mt-0 bg-white singleProduct singleBody">
                        <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    <li class="d-flex flex-column justify-content-center align-items-center 
                                                        ...
                                                        <a href="#"><img src="<?php echo $img_list[$x]; ?>" id="product_img<?php echo $x; ?>" onclick="changeMainImg(<?php echo $x; ?>);" class="img-thumbnail mt-1 mb-1" /></a>
                                                    </li>
                                                <?php
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    ...
                                                    <div class="col-6 my-2"> 
                                                        <span class="fs-4 fw-bold text-success">Condition :<?php if ($product_data["condition_condition_id"] == '1') {
                                                                                                    echo ("Brand New");
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        ...
                                                        <span class="fs-5 text-primary"><b>Item Colour : </b><?php echo $color_data["clr_name"]; ?> </span> <br>
                                                        <span class="fs-5 text-primary"><b>Item Condition : </b><?php if ($product_data["condition_condition_id"] == '1') {
                                                                                                    echo ("Brand New");
                                                                                                } else if ($product_data["condition_condition_id"] == '2') {
                                                                                                    echo ("Used");
                                                                                                } else {
                                                                ...
                                                                <div class="row g-2">
                                                                    ...
                                                                    <div class="border border-1 border-secondary rounded overflow-hidden 
                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="position-absolute qty-buttons" style="background-color:yellow;">
                                                                        ...
                                                                        <div class="col-12 mt-5">
                                                                            <div class="row">
                                                                                <div class="col-4 d-grid">
                                                                                    <button class="btn btn-success" type="submit" id="payhere-payment" onclick="paynow(<?php echo $pid; ?>);">Pay Now
                                                                                        <br><i class="bi bi-credit-card-fill"></i>
                                                                                    </button>
                                                                                </div>
                                                                                <div class="col-4 d-grid">
                                                                                    <button class="btn btn-primary" onclick="addToCart(<?php echo $product_data['id']; ?>);">Add To Cart <br><i class="bi bi-cart4 text-white fs-5"></i></button>
                                                                                </div>
                                                                                <div class="col-4 d-grid">
                                                                                    <button class="col-12 btn btn-light border border-danger" style="color: black;" onclick="addToWatchlist(<?php echo $product_data['id']; ?>);"> Add to Watchlist
                                                                                        <br><i class="bi bi-heart-fill text-danger fs-5"></i>
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                            ...
                            <div class="col-12 bg-white relatedBody">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row border border-1 border-dark rounded overflow-scroll me-0" style="height: 330px; background-color: whitesmoke;">
