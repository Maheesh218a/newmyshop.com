...
<head>
    ...
    <title>Invoice | iMobile Shop</title>
...
<body class="mt-2" style="background-color: #f7f7ff;">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 fs-1 fw-bold text-center">INVOICE</div>
                ...
                <div class="page-header text-blue-d2">
                    ...
                    <div class="page-tools">
                        <div class="action-buttons">
                            <button class="btn btn-dark me-2" onclick="window.print();" id="print-btn"><i class="bi bi-printer-fill"></i> Print</button>
                            <button class="btn btn-danger me-2" onclick="window.print();" id="print-btn"><i class="bi bi-filetype-pdf"></i> Export as PDF</button>
                        </div>
                    </div>
                </div>
            ...
            -->
                                ...
                                <div>
                                    ...
                                    <a href="home.php" class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0">Back to Home Page</a>
                                </div>
                            </div>
                        </div>
                    </div>
