...
<head>
    ...
    <title>Advanced Search | iMobile Shop</title>

    <link rel="stylesheet" href="bootstrap.css" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="style.css" />

    <link rel="icon" href="resources/5870.jpg" />

</head>

<body class="bg-info" style="background-image: url(resources/search.jpg);background-size: cover; background-position: center; background-repeat: no-repeat;">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="offset-lg-1 col-12 col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-2 mb-1 d-grid">
                                <button class="btn btn-warning" onclick="clearSort();">Clear All</button>
                            </div>
                            <div class="col-12 mt-2 mb-1 d-grid">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bg-body rounded mb-3" style="background-image: url(resources/cart03.jpg);background-size: cover; background-position: center; background-repeat: no-repeat;">
                <div class="row">
                    <div class="offset-lg-1 col-12 col-lg-10 text-center">
                        <div class="row" id="view_area">
                            <div class="offset-5 col-2 mt-5">
                                <span class="fw-bold text-warning"><i class="bi bi-search h1" style="font-size: 100px;"></i></span>
                            </div>
                            <div class="offset-3 col-6 mt-3 mb-5">
                                <span class="h1 text-warning fw-bold">No Items Searched Yet...</span>
                            </div>
                        </div>
                    </div>
                </div>
