...
<head>
    ...
    <title>My Products | iMobile Shop</title>
...
?>
    ...
    <body style="background-color: #E9EBEE;" class="myProductsBody">
    <?php require "header_no.php" ?>
    <br>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="r3" id="r">
                                                <label class="form-check-label" for="u">
                                                    Re-Condition
                                                </label>
                                            </div>
                        ...
                        <!-- product -->
                        <div class="col-12 col-lg-9 mt-3 mb-3 bg-white" style="background-image: url(resources/apple.jpg); background-size: cover; background-position: center; background-repeat: no-repeat;">
                                            ...
                                            <div class="card mb-3 mt-3 col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-4 mt-4">
                                                        ...
                                                        <a href="" onclick="visit();"><img src="<?php echo $product_img_data["img_path"]; ?>" class="img-fluid rounded-start" /></a>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                        <a href="" onclick="visit();" class="text-decoration-none"><h5 class="card-title fw-bold"><?php echo $selected_data["title"]; ?></h5></a>
                                                        <span class="badge rounded-pill text-bg-info">
                                                        <?php if ($selected_data["condition_condition_id"] == '1') {
                                                            echo ("Brand New");
                                                            ...
                                                            <div class="form-check form-switch">
                                                                ...
                                                                <label class="form-check-label fw-bold text-info" for="<?php echo $selected_data["id"]; ?>">
                                                                    <?php if ($selected_data["status_id"] == 2) { ?>
                                                                        Click it to Activate This Product
                                                                    <?php } else {
                                                                    ?>
                                                                        <p class="text-danger">Click it to Deactivate This Product</p>
                                                                    <?php
                                                                    } ?>
                                                                </label>
                                                            </div>
                    ...
                    <div class="row text-center">
                        <div class="col-12 bg-body mt-5 mb-5 text-center">
                            <span class="text-center text-bg-warning fw-bolder " style="font-size: xx-large;">
                                Hello Welcome to iMobile shop <br> Your are in iMobile shop <br> My Product Page <br> iMobile.lk
                            </span>
                        </div>
                    </div>
                </div>
