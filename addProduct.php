...
<head>
    ...
    <title>Add New Product | iMobile Shop</title>
    <link rel="stylesheet" href="bootstrap.css" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css" />
    <link rel="stylesheet" href="style.css" />

    <link rel="icon" href="resources/proAdd.png" />

</head>

<body class="addProductBody">
                ...
                <div class="col-12">
                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 border-end border-success">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="by" name="c" />
                                                        <label class="form-check-label fw-bold" for="u">Re-Condition</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                    <label class="form-label fw-bold" style="font-size: 20px; color:azure;">Product Description</label>
                                </div>
                                <div class="col-12">
                                    <textarea cols="30" rows="15" class="form-control" id="desc" style="background-color: blanchedalmond;"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <label class="form-label fw-bold" style="font-size: 20px; color:red;">Notice...</label><br />
                            <label class="form-label bg-warning">
                                We are taking 7.5% of the product from price from every
                    ...
                    <div class="row text-center">
                        <div class="col-12 bg-body mt-5 mb-5 text-center">
                            <span class="text-center text-bg-warning fw-bolder " style="font-size: xx-large;">
                                Hello Welcome to iMobile shop <br> Your are in iMobile shop <br> Product Update Page <br> iMobile.lk
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-center">
                        <div class="col-12 bg-body mt-5 mb-5 text-center">
                            <span class="text-center text-bg-light fw-bolder" style="font-size: xx-large;">
                                Now You are Signout our Shop <br> <br> If you want to sell Your products <br>Please Sign In and Try again
                            </span>
                        </div>
                    </div>
                </div>
